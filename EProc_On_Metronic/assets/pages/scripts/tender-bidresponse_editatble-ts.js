var TablePreferencesEditable = function () {
    var e = function () {
        function e(e, t) {
        ...
        function t(e, t) {
            ...
            $.ajax({
                    url: "/Home/SpecialCatGroups",
                    datatype: "JSON",
                    type: "Get",
                    success: function(data) {
                        for (var i = 0; i < data.length; i++) {
                            $('#ddlspecialgrpes').append('<option value="' +
                                data[i].Code +
                                '">' +
                                data[i].Description +
                                '</option>');
                ...
                a[1].innerHTML =
                    '<select class="form-control select2" id="ddlspecialgrpes" name="ddlspecialgrpes" data_live_search = "true"><option value="">--select country--</option></select>',
                ...
                a[3].innerHTML =
                    ...
                    '<input type="text" class="form-control input-circle-left" readonly id="crtEffDte" value="' +
                    n[3] +
                    '">' +
                ...
                a[4].innerHTML =
                    '<div class="input-group input-medium date date-picker" data-date="12-02-2012" data-date-viewmode="years">' +
                    '<input type="text" class="form-control input-circle-left" readonly id="crtEXpDte" value="' +
                    n[4] +
                    '">' +
                    '<span class="input-group-btn input-circle-right">' +
                    '<button class="btn default" type="button">' +
